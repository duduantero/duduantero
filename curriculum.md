# Eduardo Antero de Moraes

📞 [(61) 98569-1684](https://api.whatsapp.com/send/?phone=5561985691684&text&type=phone_number&app_absent=0)

✉️ xduduanterox@gmail.com

📍 Brasília, DF

🌐 https://www.linkedin.com/in/eduardoantero/
...
- **Estágiario de Desenvolvimento de Software**
  - Agência Nacional de Transportes Aquáticos, Agosto de 2023 a Agosto de 2024
    <details>
...
- Pós-graduação em **Automação de Teste de Software**
    - Facint fevereiro de 2026 a dezembro de 2026
- Graduação em **Engenharia de Software**
    - Universidade Católica de Brasília , janeiro de 2022 a dezembro de 2025

---

### 🛠️ Habilidades e Competências

- Uso das ferramentas Jira (Zephyr) e Trello  para o acompanhamento das atividades dos projetos e gestão de bugs.
- Uso do DBeaver para realização de consultas SQL nos bancos de dados das aplicações.
- Conhecimento básico em linguagens de programação Java, Javascript.
- Conhecimento nas ferramentas de testes automatizados, Cypress
- Conhecimento na ferramenta de teste de API, Postmann
- Noções básicas de GIT e na utilização das plataformas GIT
...
Faça o download do currículo clicando [aqui]().
